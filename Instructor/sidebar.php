    ...
    <div class="collapse navbar-collapse" id="sidenav">
        <div class="navbar-nav flex-column">
            ...
            <ul class="list-unstyled ms-n2 mb-4">
                ...
                <!-- Nav item -->
                <li class="nav-item">
                    <a class="nav-link" href="instructor-courses.php"><i class="fe fe-book nav-icon"></i>My Courses</a>
                </li>
                <!-- Nav item -->
                <li class="nav-item">
                ...
                <!-- Nav item -->
                <li class="nav-item">
                    <a class="nav-link" href="instructor-earning.html"><i class="fe fe-pie-chart nav-icon"></i>Earnings</a>
                </li>
                <!-- Nav item -->
                <li class="nav-item">
                    <a class="nav-link" href="instructor-order.html"><i class="fe fe-shopping-bag nav-icon"></i>Orders</a>
                </li>
                <!-- Nav item -->
                <li class="nav-item">
                ...
                <!-- Nav item -->
                <li class="nav-item">
                    <a class="nav-link" href="instructor-payouts.html"><i class="fe fe-dollar-sign nav-icon"></i>Payouts</a>
                </li>
            </ul>
            <!-- Navbar header -->
